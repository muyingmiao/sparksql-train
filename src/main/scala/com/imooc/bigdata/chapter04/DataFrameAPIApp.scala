...
object DataFrameAPIApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // val people: DataFrame = spark.read.json("file:///Users/rocky/IdeaProjects/imooc-workspace/sparksql-train/data/people.json")
...
//    spark.sql("select name from people where age > 21").show()
    ...
    val zips: DataFrame = spark.read.json("file:///Users/rocky/IdeaProjects/imooc-workspace/sparksql-train/data/zips.json")
