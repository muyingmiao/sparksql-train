...
//    jsonDF.show()
  ...
  def json(spark:SparkSession): Unit = {
    ...
    val jsonDF2: DataFrame = spark.read.json("file:///Users/rocky/IdeaProjects/imooc-workspace/sparksql-train/data/people2.json")
  ...
  def text(spark:SparkSession): Unit = {
    ...
    import spark.implicits._
    val textDF: DataFrame = spark.read.text("file:///Users/rocky/IdeaProjects/imooc-workspace/sparksql-train/data/people.txt")
